import { WorkerConnectionStatus } from "@/components/ConnectionStatus";
...
export default async function WorkerLayout({ children }: LayoutProps<"/worker">) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col">
      <header className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-line bg-surface/95 px-4 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] backdrop-blur">
